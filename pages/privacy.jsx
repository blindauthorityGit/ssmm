...
const Privacy = (props) => {
    ...
    return (
        <div className="font-block whitespace-normal break-words">
            <div className=" content px-8 pt-8">
                <div className="container text-[#fff] m-auto max-w-2xl impressum datenschutz textDark text-left mt-16 whitespace-normal">
                    {" "}
                    <a className="text-3xl" href="../">
                        <BiArrowBack className="icon" height="2rem" width="2rem"></BiArrowBack>
                    </a>
                    <h1 className="pt-8 text-2xl font-bold pb-6">Datenschutz­erklärung</h1>
                    <h2 className="text-xl font-bold pb-6">1. Datenschutz auf einen Blick</h2>
                    <h3 className="text-lg font-bold pb-4 pt-6">Allgemeine Hinweise</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Datenerfassung auf dieser Website</h3>{" "}
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Analyse-Tools und Tools von Dritt­anbietern</h3>{" "}
                    <p>
                    ...
                    <h2 className="text-xl font-bold pb-6 pt-8">2. Hosting</h2>
                    <h3 className="text-lg font-bold pb-4 pt-6">Externes Hosting</h3>{" "}
                    <p>
                    ...
                    <h2 className="text-xl font-bold pb-6 pt-8">3. Allgemeine Hinweise und Pflicht­informationen</h2>
                    <h3 className="text-lg font-bold pb-4 pt-6">Datenschutz</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Hinweis zur verantwortlichen Stelle</h3>{" "}
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Speicherdauer</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Recht auf Daten­übertrag­barkeit</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">SSL- bzw. TLS-Verschlüsselung</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Auskunft, Löschung und Berichtigung</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Recht auf Einschränkung der Verarbeitung</h3>{" "}
                    <p>
                    ...
                    <h2 className="text-xl font-bold pb-6 pt-8">4. Datenerfassung auf dieser Website</h2>
                    <h3 className="text-lg font-bold pb-4 pt-6">Anfrage per E-Mail, Telefon oder Telefax</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Kommunikation via WhatsApp</h3>{" "}
                    <p>
                    ...
                    <p>
                        ...
                        (z. B. Absender, Empfänger und Zeitpunkt). Wir weisen ferner darauf hin, dass WhatsApp nach
                        eigener Aussage, personenbezogene Daten seiner Nutzer mit seiner in den USA ansässigen
                        Konzernmutter Facebook teilt. Weitere Details zur Datenverarbeitung finden Sie in der
                    ...
                    <p>
                        Der Einsatz von WhatsApp erfolgt auf Grundlage unseres berechtigten Interesses an einer
                        möglichst schnellen und effektiven Kommunikation mit Kunden, Interessenten und sonstigen
                        Geschäfts- und Vertragspartnern (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine entsprechende
                        Einwilligung abgefragt wurde, erfolgt die Datenverarbeitung ausschließlich auf Grundlage der
                        Einwilligung; diese ist jederzeit mit Wirkung für die Zukunft widerrufbar.
                    </p>{" "}
                    <p>
                        Die zwischen und auf WhatsApp ausgetauschten Kommunikationsinhalte verbleiben bei uns, bis Sie
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Google Forms</h3>{" "}
                    <p>
                        Wir haben Google Forms auf dieser Website eingebunden. Anbieter ist die die Google Ireland
                        Limited, Gordon House, Barrow Street, Dublin 4, Irland (nachfolgend Google).
                    </p>{" "}
                    <p>
                        Google Forms ermöglicht es uns, Online-Formulare zu erstellen um Nachrichten, Anfragen und
                        sonstige Eingaben unserer Websitebesucher strukturiert zu erfassen. Alle von Ihnen getätigten
                        Eingaben werden auf den Servern von Google verarbeitet. Google Forms speichert ein Cookie in
                        Ihrem Browser, das eine eindeutige ID enthält (NID-Cookie). Dieses Cookie speichert verschiedene
                        Informationen wie beispielsweise Ihre Spracheinstellungen.
                    </p>{" "}
                    <p>
                        Der Einsatz von Google Forms erfolgt auf Grundlage unseres berechtigten Interesses an einer
                        möglichst nutzerfreundlichen Ermittlung Ihres Anliegens (Art. 6 Abs. 1 lit. f DSGVO). Sofern
                    ...
                    <p>
                        Weitere Informationen entnehmen Sie der Datenschutzerklärung von Google unter{" "}
                        <a href="https://policies.google.com/" target="_blank" rel="noopener noreferrer">
                            https://policies.google.com/
                        </a>
                        .
                    </p>
                    <h2 className="text-xl font-bold pb-6 pt-8">5. Plugins und Tools</h2>
                    <h3 className="text-lg font-bold pb-4 pt-6">YouTube mit erweitertem Datenschutz</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Google Web Fonts</h3>{" "}
                    <p>
                    ...
                    <h3 className="text-lg font-bold pb-4 pt-6">Google Maps</h3>{" "}
                    <p>
                    ...
                    <p>
                        ...
                        gespeichert. Der Anbieter dieser Seite hat keinen Einfluss auf diese Datenübertragung. Wenn
